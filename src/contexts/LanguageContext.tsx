...
const translations = {
  en: {
    ...
    browseCollection: "Browse our collection of premium tools",
    searchSoftware: "Search software...",
    userReviews: "User Reviews",
    seeWhatUsers: "See what our users say about their experience",
    ...
    downloadDesc: "Download your desired software package from our catalog.",
    extractStep: "Extract Files",
    extractDesc: "Extract the archive using the provided password.",
    installStep: "Install",
    installDesc: "Run the installation file and follow the setup wizard.",
    activateStep: "Activate",
    activateDesc: "Apply the included patch or keygen to activate the software.",
  ...
  es: {
    ...
    browseCollection: "Explora nuestra colección de herramientas premium",
    searchSoftware: "Buscar software...",
    userReviews: "Reseñas de Usuarios",
    seeWhatUsers: "Mira lo que nuestros usuarios dicen sobre su experiencia",
    ...
    downloadDesc: "Descarga el paquete de software deseado desde nuestro catálogo.",
    extractStep: "Extraer Archivos",
    extractDesc: "Extrae el archivo usando la contraseña proporcionada.",
    installStep: "Instalar",
    installDesc: "Ejecuta el archivo de instalación y sigue el asistente de configuración.",
    activateStep: "Activar",
    activateDesc: "Aplica el parche incluido o keygen para activar el software.",
  ...
  hi: {
    ...
    browseCollection: "हमारे प्रीमियम टूल्स का संग्रह देखें",
    searchSoftware: "सॉफ्टवेयर खोजें...",
    userReviews: "उपयोगकर्ता समीक्षाएँ",
    seeWhatUsers: "देखें कि हमारे उपयोगकर्ता अपने अनुभव के बारे में क्या कहते हैं",
    ...
    downloadDesc: "हमारे कैटलॉग से अपना वांछित सॉफ्टवेयर पैकेज डाउनलोड करें।",
    extractStep: "फाइलें निकालें",
    extractDesc: "दिए गए पासवर्ड का उपयोग करके आर्काइव को एक्सट्रैक्ट करें।",
    installStep: "इंस्टॉल करें",
    installDesc: "इंस्टॉलेशन फाइल चलाएं और सेटअप विज़ार्ड का पालन करें।",
    activateStep: "सक्रिय करें",
    activateDesc: "सॉफ्टवेयर को सक्रिय करने के लिए शामिल पैच या कीजन लागू करें।",
